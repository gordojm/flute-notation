...
const fingeringChart: Record<string, string[]> = {
  ...
  'A#4': ['key-bflat', 'key-b', 'key-eflat'], // Using the Bb thumb key for cleaner diagrams
  Bb4:   ['key-bflat', 'key-b', 'key-eflat'],

  // ── 5th octave (C major scale) ──────────────────────────────────────────
  C5:  ['key-b', 'key-eflat'], // Left thumb (key-c) is specifically lifted here
  D5:  ['key-c', 'key-a', 'key-g', 'key-f', 'key-e', 'key-d'], // Left index (key-b) and right pinky are lifted
  ...
  'C#5': ['key-eflat'], // All fingers open except right pinky
  Db5:   ['key-eflat'],
  ...
  'A#5': ['key-bflat', 'key-b', 'key-eflat'],
  Bb5:   ['key-bflat', 'key-b', 'key-eflat'],
}
